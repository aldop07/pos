...
# Tampilan menu Dokumentasi
                ...
                # Tampilkan menu sidebar untuk user
                menu = st.sidebar.selectbox('', ['Dokumentasi','Daftar Produk'])
                if menu == 'Dokumentasi':
                    st.write('Halaman Dokumentasi')
                elif menu == 'Daftar Produk':
                    st.write('Halaman Daftar Produk')
                # dst.
        else:
            st.error("Username, password atau hak akses salah")
